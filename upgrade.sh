...
#URL=https://raw.github.com/camilorojasg/packet_forwarder/master/multitech-bin/${FILENAME}
URL=https://raw.github.com/camilorojasg/multitech-installer/master/${FILENAME}
